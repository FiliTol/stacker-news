...
The following command creates a datatable object that has 2 columns containing the post code and the comment code, respectively.

```{r}
posts_graph <- posts_graph[, .(Commentors = unlist(tstrsplit(CommentsItemCode, ", ", type.convert = TRUE))), by = "ItemCode"]
```
