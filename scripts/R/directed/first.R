...
posts_author_stacked <- p_first_period[, .(Sats = sum(Sats)), by = .(Author)]
comments_author_stacked <- c_first_period[, .(Sats = sum(Sats)), by = .(Author)]
...
clean_posts <- subset(p_first_period, select = c(ItemCode, Sats, Author, Timestamp, CommentsItemCode))
clean_comments <- subset(c_first_period, select = c(ItemCode, Sats, Author, Timestamp, CommentsItemCode))
...
png(filename = 'images/directed/first/general_graph.png')
...
ggsave('images/directed/first/general_total_degree_distribution.png')
...
ggsave('images/directed/first/general_contributors_degree.png')
...
png(filename = 'images/directed/first/general_Q1.png')
plot(decompose(g)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
...
png(filename = 'images/directed/first/general_Q2.png')
plot(decompose(g)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
     layout = layout_with_lgl,
...
png(filename = 'images/directed/first/general_Q3.png')
plot(decompose(g)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
     layout = layout_with_lgl,
...
png(filename = 'images/directed/first/general_Q4.png')
plot(decompose(g)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
     layout = layout_with_lgl,
...
ggsave('images/directed/first/general_degree_of_separation.png')
