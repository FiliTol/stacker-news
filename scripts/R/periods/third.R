...
coul  <- brewer.pal(4, "Set1") 
my_color = coul[as.numeric(as.factor(V(g_third_posts)$catSats))]
my_color[V(g_third_posts)$catSats=="Q1"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q1"], alpha.f = 1)
my_color[V(g_third_posts)$catSats=="Q2"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q2"], alpha.f = 0.1)
my_color[V(g_third_posts)$catSats=="Q3"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q3"], alpha.f = 0.1)
my_color[V(g_third_posts)$catSats=="Q4"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q4"], alpha.f = 0.1)

png(filename = 'images/third/general_Q1.png')
...
coul  <- brewer.pal(4, "Set1") 
my_color = coul[as.numeric(as.factor(V(g_third_posts)$catSats))]
my_color[V(g_third_posts)$catSats=="Q1"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q1"], alpha.f = 0.1)
my_color[V(g_third_posts)$catSats=="Q2"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q2"], alpha.f = 1)
my_color[V(g_third_posts)$catSats=="Q3"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q3"], alpha.f = 0.1)
my_color[V(g_third_posts)$catSats=="Q4"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q4"], alpha.f = 0.1)

png(filename = 'images/third/general_Q2.png')
plot(decompose(g_third_posts)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
     layout = layout_with_fr,
...
my_color[V(g_third_posts)$catSats=="Q1"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q1"], alpha.f = 0.1)
my_color[V(g_third_posts)$catSats=="Q2"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q2"], alpha.f = 0.1)
my_color[V(g_third_posts)$catSats=="Q3"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q3"], alpha.f = 1)
my_color[V(g_third_posts)$catSats=="Q4"] <- adjustcolor(my_color[V(g_third_posts)$catSats=="Q4"], alpha.f = 0.1)

png(filename = 'images/third/general_Q3.png')
plot(decompose(g_third_posts)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
     layout = layout_with_fr,
...
png(filename = 'images/third/general_Q4.png')
plot(decompose(g_third_posts)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
     layout = layout_with_fr,
