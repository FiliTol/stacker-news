...
posts_author_stacked <- p_second_period[, .(Sats = sum(Sats)), by = .(Author)]
comments_author_stacked <- c_second_period[, .(Sats = sum(Sats)), by = .(Author)]
...
clean_posts <- subset(p_second_period, select = c(ItemCode, Sats, Author, Timestamp, CommentsItemCode))
clean_comments <- subset(c_second_period, select = c(ItemCode, Sats, Author, Timestamp, CommentsItemCode))
...
png(filename = 'images/directed/second/general_graph.png')
...
ggsave('images/directed/second/general_total_degree_distribution.png')
...
ggsave('images/directed/second/general_contributors_degree.png')
...
png(filename = 'images/directed/second/general_Q1.png')
plot(decompose(g)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
...
png(filename = 'images/directed/second/general_Q2.png')
plot(decompose(g)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
     layout = layout_with_lgl,
...
png(filename = 'images/directed/second/general_Q3.png')
plot(decompose(g)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
     layout = layout_with_lgl,
...
png(filename = 'images/directed/second/general_Q4.png')
plot(decompose(g)[[1]],
     vertex.label = NA,
     vertex.color = my_color,
     layout = layout_with_lgl,
...
ggsave('images/directed/second/general_degree_of_separation.png')
